...
script1 = "object_detection.py"  # Replace with the actual path to your YOLOv8 script
script2 = "api_testing.py"  # Replace with the actual path to your voice recognition script
